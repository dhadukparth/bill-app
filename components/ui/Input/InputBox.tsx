      ...
      <View className="mb-2">
        ...
        <View className="relative">
          ...
          <TextInput
            ...
            autoComplete="off"
            className={cn(
              'bg-gray-100 dark:bg-gray-800 py-3 px-4 text-black dark:text-white placeholder:text-gray-800 dark:placeholder:text-gray-300 text-base font-inter-regular font-normal rounded-lg border border-white',
              {
                'pl-12':
                  (icon && iconDirection === 'left') ||
