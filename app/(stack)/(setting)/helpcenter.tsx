...
const HelpCenterScreen = () => {
  ...
  const popularTopicsList = [
    {
      title: 'Account',
      link: '',
      icon: <Feather name="user" size={iconSize} color={globalStyle.icon.color} />,
    },
    {
      title: 'Privacy',
      link: '',
      icon: (
        <Ionicons name="shield-checkmark-outline" size={iconSize} color={globalStyle.icon.color} />
      ),
    },
    {
      title: 'Security',
      link: '',
      icon: <Feather name="lock" size={iconSize} color={globalStyle.icon.color} />,
    },
    {
      title: 'Settings',
      link: '',
      icon: <Feather name="settings" size={iconSize} color={globalStyle.icon.color} />,
    },
  ];
  ...
  const helpCategoryList = [
    {
      ...
      link: '',
      icon: (
        <FontAwesome6 name="question-circle" size={iconSize - 4} color={globalStyle.icon.color} />
      ),
    },
    {
    ...
    },
    {
      ...
      link: '',
      icon: <Ionicons name="wallet-outline" size={iconSize - 4} color={globalStyle.icon.color} />,
    },
    {
      title: 'Privacy & Data',
  ...
  const needHelpList = [
    {
      title: 'Chat',
      icon: <Ionicons name="chatbubble-outline" size={iconSize} color={globalStyle.icon.color} />,
    },
    {
      title: 'Email',
      icon: <Fontisto name="email" size={iconSize} color={globalStyle.icon.color} />,
    },
    {
      title: 'Call',
      icon: <Feather name="phone" size={iconSize} color={globalStyle.icon.color} />,
    },
  ];
  ...
  return (
    <ScrollView>
      <Container className="p-0">
              ...
              <View className="mt-4 flex flex-row justify-start items-center gap-6">
                {popularTopicsList.map((item, index) => (
                  <View key={index} className="flex flex-col justify-center items-start gap-2">
                    <View className="bg-gray-800 size-16 rounded-md flex justify-center items-center">
                      {item.icon}
                    </View>
          ...
          <View className="mt-4">
            ...
            <View className="mt-4">
              {helpCategoryList.map((item, index) => (
                <View key={index} className="bg-gray-800 p-4 rounded-md my-3">
            ...
            <View className="mt-4 flex flex-row justify-between items-center gap-6">
              {needHelpList.map((item, index) => (
                <View key={index} className="flex flex-col justify-center items-center gap-2">
                  <View className="bg-gray-800 size-24 rounded-md flex justify-center items-center">
                    {item.icon}
                  </View>
                  <Title className="text-center">{item.title}</Title>
                </View>
        ...
        <View className="bg-gray-800 p-4 mt-4">
